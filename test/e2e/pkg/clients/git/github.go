...
func (g *GitHubClient) ListPullRequests(repository string) ([]*PullRequest, error) {
	prs, err := g.Client.ListPullRequests(repository)
	if err != nil {
		return nil, err
	}
...
func (g *GitHubClient) CreateFile(repository, pathToFile, content, branchName string) (*RepositoryFile, error) {
	file, err := g.Client.CreateFile(repository, pathToFile, content, branchName)
	if err != nil {
		return nil, err
	}
...
func (g *GitHubClient) GetFile(repository, pathToFile, branchName string) (*RepositoryFile, error) {
	contents, err := g.Client.GetFile(repository, pathToFile, branchName)
	if err != nil {
		return nil, err
	}
...
func (g *GitHubClient) MergePullRequest(repository string, prNumber int) (*PullRequest, error) {
	mergeResult, err := g.Client.MergePullRequest(repository, prNumber)
	if err != nil {
		return nil, err
	}
	return &PullRequest{
...
func (g *GitHubClient) UpdatePullRequestBranch(repository string, prNumber int) error {
	return g.Client.UpdatePullRequestBranch(repository, prNumber)
}

func (g *GitHubClient) CreatePullRequest(repository, title, body, head, base string) (*PullRequest, error) {
	pr, err := g.Client.CreatePullRequest(repository, title, body, head, base)
	if err != nil {
		return nil, err
	}
	return &PullRequest{
...
func (g *GitHubClient) ForkRepository(sourceRepoName, targetRepoName string) error {
	_, err := g.Client.ForkRepository(sourceRepoName, targetRepoName)
	if err != nil {
		return err
	}
	return nil
...
func (g *GitHubClient) DeleteRepositoryIfExists(repoName string) error {
	err := g.Client.DeleteRepositoryIfExists(repoName)
	if err != nil {
		return err
	}
	return nil
